...
import { LEKKI_HEADMASTER, getNovelQuestions } from '../data/lekkiHeadmaster'
...
export default function NovelPage() {
  ...
  const novel = LEKKI_HEADMASTER

  const handlePracticeNovel = () => {
    const questions = getNovelQuestions()
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-slate-400 text-sm">Study guide for examination</p>
            </div>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <ul className="text-slate-300 text-sm space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <ChevronRight className="w-4 h-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                    Practice with flashcards to memorize key quotes and chapter events
                  </li>
                </ul>
              </div>
            </div>
